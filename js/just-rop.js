...
function rop() {
	...
	this.start = function(address, dataAddress) {
	...
	this.getVariableLo = function(n) {
		return getU32from(chainAddress + chainLength + n * 8 + 0);
	}

	this.getVariableHi = function(n) {
		return getU32from(chainAddress + chainLength + n * 8 + 4);
	}
